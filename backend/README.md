...
## Project Structure
    ...
    ├── loyalty_card_market_44650  # Django project configurations
...
1. Clone this repo and `cd loyalty_card_market_44650`
...
2. Clone this repo and `cd loyalty_card_market_44650`
